...
class UnitTestCharun(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.charun = Charun(charun_tac.couchdb_url, charun_tac.db_name,
                             charun_tac.initial)
    ...
    def test_10_receive_data(self):
        ...
        self.assertTrue(self.charun.couch_connect.store.called,
                      "storage function should have been called, but was not")
    ...
    def test_20_receive_data(self):
        ...
        self.assertTrue(self.charun.log.msg.called)
        self.assertFalse(self.charun.couch_connect.store.called,
                         "storage function has been erroneously called")
    ...
    def test_40_receive_function(self):
        """test function reception: a serialized function string
        gets integrated."""
        self.charun.datagramReceived(marshal.dumps(
                                     charun_tac.test_initial.func_code),
                                     ("localhost", 30000))
